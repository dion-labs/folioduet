...
Fish Audio currently documents `s2.1-pro-free` as free through November 30, 2026, subject to fair use and without SLA or latency guarantees. Treat the remaining period as a learning window, and do not imply permanent free neural narration. Source: [Fish Audio S2.1 Pro extension announcement](https://www.reddit.com/r/FishAudio_Official/comments/1vzzqft/fish_audio_anniversary_update_s21_pro_free_trial/).
